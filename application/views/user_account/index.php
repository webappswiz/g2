	...
	<div class="claim-form2">
		<form class="process-form" name="order" method="POST" action="/user_account/addDog">
			...
			<div class="radio-list">
				...
				<input type="radio" name="size" value="1" class="" checked> <?php echo __( 'Icipici (max 9kg)' ); ?>
				<input name="size" value="2" type="radio" class=""> <?php echo __( 'Éppen jó(10-24kg)' ); ?>
				<input name="size" value="3" type="radio" class=""> <?php echo __( 'Igazi óriás(25kg+)' ); ?>
			</div>
			<div class="radio-list">
				<label for="last-name"><?php echo __( 'Kutyus neme*' ); ?></label>
				<input type="radio" name="gender" value="0" class="" checked> <?php echo __( 'Lány' ); ?> <input
					name="gender" value="1" type="radio" class=""> <?php echo __( 'Fiú' ); ?>
			</div>
			<?php
			...
			<div class="radio-list">
				...
				<input type="radio" class="alerg_yes" value="1" name="alerg"> <?php echo __( 'Igen' ); ?> <input
					type="radio" value="0" name="alerg" class="alerg_no" checked> <?php echo __( 'Nem' ); ?>
			</div>
				...
				<div class="claim-form-container">
					<div class="claim-form">
						...
						<form method="POST" action="/user_account/editShipping" id="shipping">
							<div style="margin-right:6px;" class="fl">
								...
								<input id="last-name" type="text" name="last-name" class="rounded"
							...
							<div style="overflow:hidden;">
								...
								<input id="" type="text" name="first-name" class="rounded"
							...
							<div class="fl" style="margin-right:6px;">
								...
								<input type="text" name="street" class="rounded" id=""
					...
					<div class="bottom-text-field">
						<div>
							...
							<input type="text" name="email" class="rounded" id="" value="<?= $current_user->email ?>"
							       readonly>
						</div>
						<div>
						...
						<div style="margin-top:50px;">
							<input type="submit" name="edit_shipping" value="<?php echo __( 'ADATAIM MENTÉSE' ); ?>"
							       class="dark-btn Szemelyes-btn rounded">
						</div>
					</div>
					</form>
					<script>
		...
		<div>
			<div class="content" style="overflow:hidden;">
						...
						?>>
							<div class="dog-profile rounded">
								...
								<div class="delete-dog" style="display: none">
									<div
										class="delete-box1 rounded"><?php echo __( 'Törölni szeretnéda kutyus profilját?' ); ?></div>
									<div class="delete-box2 rounded"><a
											href="<?= URL::base( true, false ) ?>user_account/removeDog/<?= $puppy->id ?>"><?php echo __( 'Igen' ); ?></a>
									</div>
									<div class="delete-box3 rounded"><a class="cancel"
									                                    style="cursor:pointer"><?php echo __( 'Mégse' ); ?></a>
									</div>
								</div>
							</div> <!--End dog profile-->
							...
							<form action="/user_account/order" method="POST">
								...
								<div>
									<input type="submit" name="submit" value="<?php echo __( 'GYERÜNK' ); ?>"
									       class="dark-btn dog-prof-btn rounded" <?= ( $status == 0 ) ? 'disabled' : '' ?>>
								</div>
							</form>
				...
				<div class="dog-profile-container" style="margin-right:0;">
					<a href="#" id="create-dog"
					   class="rounded dog-btn dark-btn"><?php echo __( 'Van egy új kutyusom!<p>Új kutyus profil létrehozása</p>' ); ?></a>
				</div>
			</div>
		</div>
		...
		<div>
			<div class="content">
				<div class="support">
					...
					<div class="claim-form-btn">
						<input type="submit" name="tovabb" value="<?php echo __( 'TOVÁBB' ); ?>" id="submit_form_invite"
