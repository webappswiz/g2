...
<section class="thanku" class="rounded">
    ...
    <a href="<?= URL::base( true, false ) ?>order/success" class="btnShare" data-title="goodiebox"
       data-desc="Hurrá, megrendeltem a legújabb Goodiebox-ot a kutyámnak! Ha Te is szeretnéd megajándékozni kis kedvencedet a legszuperebb meglepidobozzal, akkor kattints a weboldalukra http://goodiebox.hu"><img
		    style="margin-top: 0px;padding: 0px;margin-right:5px;"
		    src="<?= URL::base( true, false ) ?>/assets/img/share_fb.png" width="64" height="64" alt="facebook"></a>
    <a class="popup"
       href="https://twitter.com/intent/tweet?text=Hurrá, megrendeltem a legújabb Goodiebox-ot a kutyámnak! Ha Te is szeretnéd megajándékozni kis kedvencedet a legszuperebb meglepidobozzal, akkor kattints a weboldalukra http://goodiebox.hu"><img
