...
<section class="claim-gift" class="rounded">
	...
	<div class="claim-box1">
		<div class="box rounded">
			<p>Ha már van regisztrált Goodiebox felhasználói fiókod, jelentkezz be! <span id="open_login"
			                                                                              style="cursor: pointer">KLIKK ide!</span>
			</p>
	...
	<div class="claim-box2">
		<div class="box rounded">
			<p>Ha még nincs regisztrált Goodiebox felhasználói fiókod, csak az ajándékkupon kódod. <span
					style="cursor: pointer" id="open_coupon">KLIKK ide!</span></p>
			<img src="<?= URL::base( true, false ) ?>/assets/img/claim-i.png">
		</div>
