...
<section class="claim-gift" class="rounded">
		...
		<div class="claim-form">
			...
			<form id="billing_form" method="POST" autocomplete="off">
				<div style="margin-right:5px;" class="fl">
					...
					<input id="customer_lastname" type="text" value="" name="customer_lastname" class="rounded"
					       required>
				</div>

				<div style="overflow:hidden;">
					<label for="customer_firstname">Keresztnév*</label>
					<input id="customer_firstname" type="text" value="" name="customer_firstname" class="rounded"
					       required>
				</div>
				<div class="clear"></div>
				<div class="add">
					<label for="customer_address">Cím*</label>
					<input type="text" name="customer_address" class="rounded" id=""
					       placeholder="Utca, házszám, ajtó, emelet" required>
				...
				<p style="margin-top:15px;">E-mail cím és jelszó megadása szükséges ahhoz, hogy később bejelentkezhess a
					Goodiebox fiókodba, követhesd aktuális rendelésed, módosíthasd a már meglévő adataidat vagy ha nincs
					rá szükséged, törölhesd.</p>
	...
	<ul class="claim-option-list">
		<li><img src="<?= URL::base( true, false ) ?>assets/img/claim-dogs1.jpg">

			<p> Icipici<input type="radio" id="size" name="group1" value="1" class="" checked></p><br/><br/> max 9kg
		</li>
		<li><img src="<?= URL::base( true, false ) ?>assets/img/claim-dogs2.jpg"> Éppen jó<input type="radio" id="size"
		                                                                                         name="group1" value="2"
		                                                                                         class=""><br/><br/>
			10-24kg
		</li>
		<li><img src="<?= URL::base( true, false ) ?>assets/img/claim-dogs3.jpg"> Igazi óriás<input type="radio"
		                                                                                            id="size"
		                                                                                            name="group1"
		                                                                                            value="3"
		                                                                                            class=""><br/><br/>
	...
	<div class="claim-form2">
		<form id="doggy_form" method="POST">
			...
			<div class="radio-list">
				...
				<input type="radio" name="gender" class="" value="0" checked="checked"> Lány <input name="gender"
				                                                                                    value="1"
				                                                                                    type="radio"
				                                                                                    class=""> Fiú
			</div>
			...
			<div class="radio-list">
				...
				<input style="cursor: pointer" type="radio" class="alerg_yes" value="1" name="alerg"> Igen <input
					style="cursor: pointer" type="radio" value="0" name="alerg" class="alerg_no" checked> Nem
			</div>
