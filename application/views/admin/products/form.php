...
<div style="text-align: center">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<select id="product_size" name="product_size[]" class="input-xxlarge" multiple="multiple">
						<option
							value="1" <?php echo ( is_array( $sizes ) && in_array( 1, $sizes ) ) ? 'selected="selected"' : '' ?>>
							Small
						</option>
						<option
							value="2" <?php echo ( is_array( $sizes ) && in_array( 2, $sizes ) ) ? 'selected="selected"' : '' ?>>
							Medium
						</option>
						<option
							value="3" <?php echo ( is_array( $sizes ) && in_array( 3, $sizes ) ) ? 'selected="selected"' : '' ?>>
							Large
						</option>
						<option
							value="4" <?php echo ( is_array( $sizes ) && in_array( 4, $sizes ) ) ? 'selected="selected"' : '' ?>>
			...
			<div class="control-group">
				...
				<div class="controls">
					<select id="dog_age" name="dog_age" class="input-xxlarge">
						<option value="1" <?php echo ( $model->product_age == 1 ) ? 'selected="selected"' : '' ?>>From 3
							months +
						</option>
						<option value="2" <?php echo ( $model->product_age == 2 ) ? 'selected="selected"' : '' ?>>From 4
							months +
						</option>
						<option value="3" <?php echo ( $model->product_age == 3 ) ? 'selected="selected"' : '' ?>>From 1
							year +
						</option>
						<option value="4" <?php echo ( $model->product_age == 4 ) ? 'selected="selected"' : '' ?>>Good
							for all ages
						</option>
					</select>
				</div>
	...
	<?php if ( $model->id ): ?>
		...
		<div class="control-group" style="text-align: center">
			<?php
			if ( isset($product_add_images) && count( $product_add_images ) > 0 ) {
