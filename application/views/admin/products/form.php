	...
	<form class="form-horizontal" style="text-align:center;display:inline-block;" method="POST" autocomplete='off'>
		<fieldset>
			<div class="control-group">
				<label class="control-label" for="package_name">Product name</label>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="package_code" name="package_code" placeholder="Package code"
			...
			<div class="control-group">
				<input type="checkbox" id="package_enabled" name="package_enabled"
				       <?php echo ( $model->enabled == 1 ) ? 'checked="checked"' : '' ?>value="1"> Package enabled
