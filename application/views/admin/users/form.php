	...
	<form class="form-horizontal" style="text-align:center;display:inline-block;" method="POST" autocomplete='off'>
		<fieldset>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="customer_firstname" name="customer_firstname"
					       placeholder="Customer's firstname" value="<?= $model->customer_firstname ?>" readonly>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="customer_lastname" name="customer_lastname" placeholder="Customer's lastname"
					       value="<?= $model->customer_lastname ?>" readonly>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="customer_email" name="customer_email" placeholder="Customer's email"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="customer_city" name="customer_city" placeholder=">Customer's city"
					       value="<?= $model->customer_city ?>" readonly>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="customer_street" name="customer_street" placeholder="Customer's street"
					       value="<?= $model->customer_street ?>" readonly>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="customer_house" name="customer_house" placeholder="Customer's house"
					       value="<?= $model->customer_house ?>" readonly>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="customer_zip" name="customer_zip" placeholder="Customer's zip"
					       value="<?= $model->customer_zip ?>" readonly>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="customer_telephone" name="customer_telephone"
					       placeholder="Customer's telephone" value="<?= $model->customer_telephone ?>" readonly>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="customer_company" name="customer_company" placeholder="Customer's company"
					       value="<?= $model->customer_company ?>" readonly>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="customer_taxcode" name="customer_taxcode" placeholder="Customer's tax code"
					       value="<?= $model->customer_taxcode ?>" readonly>
				</div>
			</div>
			<div class="control-group">
