	...
	<form class="form-horizontal" style="text-align:center;display:inline-block;" method="POST" autocomplete='off'>
		<fieldset>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="shelter_name" name="shelter_name" placeholder="Shelter's name"
					       value="<?= $model->shelter_name ?>">
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="shelter_email" name="shelter_email" placeholder="Shelter's email"
					       value="<?= $model->email ?>">
				</div>
			</div>
