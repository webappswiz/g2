	...
	<form class="form-horizontal" style="text-align:center;display:inline-block;" method="POST" autocomplete='off'>
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="invoice_date" name="invoice_date" placeholder=""
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="completion_date" name="completion_date" placeholder=""
					       value="<?php echo date( 'Y-m-d H:i:s' ); ?>">
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="due_date" name="due_date" placeholder=""
					       value="<?php echo date( 'Y-m-d H:i:s' ); ?>">
				</div>
			</div>
			<div class="control-group">
