	...
	<div class="span2 pull-left">
		<div class="well sidebar-nav">
			<ul class="nav nav-tabs nav-stacked">
				...
				<li <?= ( $model->type == 1 ) ? 'class="active"' : "" ?>><a href="/admin/templates/edit/1">Registration
						email template</a></li>
				<li <?= ( $model->type == 2 ) ? 'class="active"' : "" ?>><a href="/admin/templates/edit/2">Order email
						template</a></li>
				...
				<li <?= ( $model->type == 4 ) ? 'class="active"' : "" ?>><a href="/admin/templates/edit/4">Invite email
						template</a></li>
				<li <?= ( $model->type == 5 ) ? 'class="active"' : "" ?>><a href="/admin/templates/edit/5">Forgot
						password email template</a></li>
				<li <?= ( $model->type == 7 ) ? 'class="active"' : "" ?>><a href="/admin/templates/edit/7">Notification
						email template</a></li>
		</div>
	</div>
			...
			<form class="form-horizontal" style="display:inline-block;" method="POST" autocomplete='off'>
				<fieldset>
					...
					<div class="control-group">
						<textarea class="input-xxlarge" rows="10" id="template_text"
						          name="template_text"><?= $model->template_text ?></textarea>
					</div>
					<h3>English text:</h3>

					<div class="control-group">
						<textarea class="input-xxlarge" rows="10" id="template_text_eng"
						          name="template_text_eng"><?= $model->template_text_eng ?></textarea>
					</div>
