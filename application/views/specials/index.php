									...
									<table>
										<tr>
											<td><a href="http://alapcafe.hu/" target="_blank">ALAP Café</a><br/>
												<a href="https://goo.gl/maps/BmYbZYikFuQ2" target="_blank"><img
														width="16"
										...
										<tr>
											<td style="padding-top:20px;"><a
												...
												<a href="https://goo.gl/maps/Tqqz62cm6at" target="_blank"><img
														width="16"
														style="margin-top:0;margin-right:5px;display:inline-block;vertical-align:top;"
						...
						<div class="collapse_content1">
							...
							<div class="cnt">
								<div class="content"
									...
									<table>
										<tr>
											<td><a href="www.flashkutyapekseg.hu" target="_blank">Flash
													kutyapékség</a><br/>
												<a href="https://goo.gl/maps/eMiThgPtKwk" target="_blank"><img
														width="16"
														style="margin-top:0;margin-right:5px;display:inline-block;vertical-align:top;"
							...
							<div class="cnt">
								<div class="content"
									...
									<table>
										<tr>
											<td>
												<a href="http://www.dogmopolite.hu" target="_blank">Dogmopolite
													Kutyakozmetika
													(Buda és Pest)</a><br/>
												<a href="https://goo.gl/maps/saU8LKQfJEv" target="_blank"><img
														width="16"
														style="margin-top:0;margin-right:5px;display:inline-block;vertical-align:top;"
														src="<?= URL::base( true, false ) ?>assets/img/pin.png"></a><span
													style="dispaly:block;">1116 Budapest Mesterházi utca 6-8.</span><br/>
												<a href="https://goo.gl/maps/zd9WnvY1xXz" target="_blank"><img
														width="16"
														style="margin-top:0;margin-right:5px;display:inline-block;vertical-align:top;"
														src="<?= URL::base( true, false ) ?>assets/img/pin.png"></a>1103
												Budapest Cserkesz utca 49.<br/>
												<a href="https://goo.gl/maps/gv9666h9oY42" target="_blank"><img
														width="16"
														style="margin-top:0;margin-right:5px;display:inline-block;vertical-align:top;"
														src="<?= URL::base( true, false ) ?>assets/img/pin.png"></a>1024
												Budapest Fillér utca 16.<br/>
												<a href="https://goo.gl/maps/v9BvnhEfxrK2" target="_blank"><img
														width="16"
														style="margin-top:0;margin-right:5px;display:inline-block;vertical-align:top;"
										...
										<tr>
											<td style="padding-top:20px;"><a href="http://ohmydogspa.hu"
											                                 target="_blank">ohmyDOG
													Boutique & Spa</a><br/>
												<a href="https://goo.gl/maps/wunTmNzN2JE2" target="_blank"><img
														width="16"
														style="margin-top:0;margin-right:5px;display:inline-block;vertical-align:top;"
														src="<?= URL::base( true, false ) ?>assets/img/pin.png"></a><span
										...
										<tr>
											<td style="padding-top:20px;"><a
													href="http://www.mancsolo-kutyakozmetika.hu"
													target="_blank">Mancsoló kutyakozmetika</a><br/>
												<a href="https://goo.gl/maps/EHiQXhbMqhS2" target="_blank"><img
														width="16"
														style="margin-top:0;margin-right:5px;display:inline-block;vertical-align:top;"
														src="<?= URL::base( true, false ) ?>assets/img/pin.png"></a><span
									...
									<table>
										<tr>
											<td>
												...
												<a href="https://goo.gl/maps/tuiH8qPNub62" target="_blank"><img
														width="16"
														style="margin-top:0;margin-right:5px;display:inline-block;vertical-align:top;"
