...
<div class="container">
	<header>
		...
		<div class="social-right">
			<ul>
				<li><a href="<?= URL::base( true, false ) ?>" class="btnShare" data-title="Goodie"
				       data-desc="Goodie"><img src="<?= URL::base( true, false ) ?>/assets/img/facebook-btn.jpg"
				                               alt="facebook"></a></li>
				<li><a class="popup" href="http://twitter.com/share"><img
							src="<?= URL::base( true, false ) ?>/assets/img/twitter-btn.jpg" alt="twitter"></a></li>
				<li><a href="#">
