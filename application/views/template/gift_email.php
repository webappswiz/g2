...
<table border="0" cellpadding="0" cellspacing="0" align="center"
       style="max-width:600;background-color:#ffffc1;text-align:center;">
	<tr Style="background-color:#e12258;width:100%;">
		<td colspan="2"><img src="<?= URL::base( true, false ) ?>assets/img/logo_gift.png" style="text-align:center;">
		</td>
	</tr>
	<tr Style="background-color:#e12258;width:100%;">
		<td colspan="2"><h2
				style="text-align:center;font-family:\'GilgongoKaps-Regular\';font-size:50px; color:#ffffc1;letter-spacing:8px; margin:0;padding:0;">
				Ajándék<span style="font-family:\'GilgongoMutombo-Regular\';font-size:35px;">kupon</span></h2></td>
	</tr>
	<tr>
	...
	<tr style="width:100%;" class="box-row">
		<td style="padding:0px 0 0 10px;width:50%; border-top:6px solid #e12258;border-left:6px solid #e12258;border-right:6px solid #e12258; text-align:left;font-family: \'gillsansmt\'; color:#e12258;">
			Ki kapja:
		</td>
		<td style="width:50%;border-top:6px solid #ffffc1;border-left:6px solid #ffffc1;border-right:6px solid #ffffc1;text-align:left;padding:15px;padding-bottom: 0px; background-color:#e12258;font-family: \'gillsansmt\'; color:#ffffc1;">
			Kuponkód:
		</td>
	</tr>
	<tr style="width:100%;" class="box-row">
	...
	<tr style="width:100%;" class="box-row">
		<td style="padding:10px 0 0 10px;width:50%; border-left:6px solid #e12258;border-right:6px solid #e12258; text-align:left;font-family: \'gillsansmt\'; color:#e12258;">
			Ki adja:
		</td>
		<td style="width:50%;border-left:6px solid #ffffc1;border-right:6px solid #ffffc1;text-align:left;padding:15px;padding-bottom: 0px; background-color:#e12258;font-family: \'gillsansmt\'; color:#ffffc1;">
			Érvényes:
		</td>
	</tr>
	<tr style="width:100%;" class="box-row">
	...
	<tr style=" width:100%;">
		<td colspan="2" style=" text-align: center; padding-top:8px;"><img
				src="<?= URL::base( true, false ) ?>assets/img/main_bg.png" width="336" height="123"></td>
	</tr>
</table>
</body>
</html>