...
<section class="process-3" class="rounded">
	<div class="claim-form-container">
		<div class="claim-form">
			<form action="<?php echo URL::site( 'user_session/reset2/?hash=' . $_GET['hash'] ); ?>" method="POST"
			      class="reset">
				<div class="add" style="margin-bottom: 5px">
					<input class="rounded" type="password" name="customer_password" id="customer_password"
					       placeholder="<?php echo __( 'Jelszó' ); ?>" required>
				</div>
				<div class="add" style="margin-bottom: 5px">
					<input class="rounded" type="password" name="password_confirm"
